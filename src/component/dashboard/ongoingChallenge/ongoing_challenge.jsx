...
const OngoingChallengesManager = () => {
  ...
  if (loading) {
    return (
      <Box sx={{ textAlign: "center", py: 4, color: "#fff" }}>
        <Typography variant="h6">Loading ongoing Completed Challenges...</Typography>
      </Box>
    );
  }
...
export default OngoingChallengesManager;
