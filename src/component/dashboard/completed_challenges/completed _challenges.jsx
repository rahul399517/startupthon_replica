...
import NewChallengeForm from "@/component/forms/complete_challenge_form";

const CompletedChallengesManager = () => {
  ...
  if (loading) {
    return (
      <Box sx={{ textAlign: "center", py: 4, color: "#fff" }}>
        <Typography variant="h6">Loading Completed Challenges...</Typography>
      </Box>
    );
  }
...
export default CompletedChallengesManager;
